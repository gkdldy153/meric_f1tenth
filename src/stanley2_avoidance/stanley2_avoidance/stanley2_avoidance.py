...
class StanleyAvoidance(Node):
    def __init__(self):
        ...
        self.declare_parameter("waypoints_path", "/home/meric/f1tenth_ws/src/waypoint_generator/src/waypoints_opt.csv")
        self.declare_parameter("waypoints_path_2nd", "/home/meric/f1tenth_ws/src/waypoint_generator/src/waypoints_opt.csv")
        ...
        self.declare_parameter("min_lookahead", 0.01)
        self.declare_parameter("max_lookahead", 0.07)
        self.declare_parameter("min_lookahead_speed", 0.3)
...
class WaypointUtils:
    def __init__(
        ...
        filepath="/home/meric/f1tenth_ws/src/waypoint_generator/src/waypoints_opt.csv",
        min_lookahead=0.5,
        max_lookahead=3.0,
        min_lookahead_speed=3.0,
        max_lookahead_speed=6.0,
        filepath_2nd="/home/meric/f1tenth_ws/src/waypoint_generator/src/waypoints_opt.csv",
        lane_number=0,
    ):
